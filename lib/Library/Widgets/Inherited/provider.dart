...
/*
ниже мы создали универсальные инхериты для обеспечения моделями виджеты 
пользовательского интерфейса. Провайдеры
один внедряет ChangeNotifier  а другой все что угодно
это не замена Провайдеру(автор Remi Rousselet). Это было написано для нас, хелперы 
*/
